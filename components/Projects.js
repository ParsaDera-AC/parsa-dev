        ...
        <div className="container mx-auto px-6 sm:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <motion.h2
              ...
              className="text-4xl sm:text-5xl font-bold text-center mb-4 mobile-text-3xl text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"
            >
            ...
            <motion.p
              ...
              className={`${isDarkMode ? 'text-white' : 'text-black'} max-w-2xl mx-auto text-base sm:text-lg mobile-text-base`}
            >
          ...
          {/* Projects Grid - Responsive for mobile */}
              ...
              >
                ...
                <div className="p-6 sm:p-8 flex flex-col flex-grow relative z-10">
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className={`px-3 py-1 text-xs rounded-full border mobile-text-xs ${
                      isDarkMode 
                  ...
                  <h3 className={`text-xl sm:text-2xl font-semibold mb-3 mobile-text-xl ${
                    isDarkMode 
                  ...
                  <p className={`text-sm sm:text-base mb-6 mobile-text-sm ${
                    isDarkMode ? 'text-gray-400' : 'text-gray-600'
                  }`}>
                    {project.description}
                  </p>

                  {/* Tech Stack - Responsive layout for mobile */}
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.techStack.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className={`px-2.5 py-1 text-xs mobile-text-xs rounded-md transition-colors duration-300 ${
                          isDarkMode 
                  ...
                  {/* Project Links - Enhanced touch targets for mobile */}
                  <div className="flex flex-wrap gap-4 mt-auto relative z-20">
                    {project.links.github ? (
                      <a
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 mobile-touch-target ${
                          isDarkMode 
                      ...
                      <div
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg mobile-touch-target ${
                          isDarkMode 
          ...
          <div className="mt-12 sm:mt-16 text-center">
            ...
            >
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`inline-flex items-center gap-3 px-6 py-3 rounded-lg mobile-touch-target shadow-lg ${
                  isDarkMode
                    ? 'bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-purple-500/30'
                    : 'bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-pink-500/20'
                } hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1`}
              >
                <FaGithub size={20} />
                <span className="font-medium">{messages?.projects?.moreOnGithub || "More on GitHub"}</span>
              </a>
            </motion.div>
          </div>
        </div>
