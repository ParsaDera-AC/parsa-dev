      ...
      >
        <div className="navbar container mx-auto flex justify-between items-center px-4 sm:px-6">
          ...
          <nav className="hidden lg:flex space-x-4 items-center">
            ...
            >
              <FaFolder size={18} className="mr-1 text-white" />
              Projects
            </motion.a>
            <motion.a
              href="#contact"
            ...
            <div className="relative language-toggle">
              ...
              >
                <FiGlobe size={20} className="text-blue-500 dark:text-blue-300" />{" "}
                {/* Explicit LinkedIn blue for light/dark modes */}
              </motion.button>
            ...
            >
              ...
              {/* Explicit GitHub black/white for light/dark modes */}
            </motion.a>
            <motion.a
            ...
            >
              {isDarkMode ? (
                ...
                <FiMoon size={20} className="text-gray-500 dark:text-gray-300" />
              )}{" "}
              {/* Explicit sun/moon colors for light/dark modes */}
            </motion.button>
          </nav>
